...
export {
	...
	AdvertisingServiceDataDictionary,
	AdvertisementDecoder
} from './core/advertisement-decoder';
...
export {
	GapAttributeValue,
	GapAttributesMetadata,
	parseGapAttributesMetadata,
	parseGapAttributesMetadataFromDictionary
} from './gap/gap-attributes-metadata';
export { GapManufacturerData, parseAdvertisementManufacturerMetadata } from './gap/gap-manufacturer-data';
export {
	iOSAdvertisingData,
	iOSAdvertisingDataKey,
	iOSAdvertisingServiceDataDictionary,
	isIOSAdvertisingData
} from './plugin/ios-advertising-data';
